...
public class WikipediaTodaysFeaturedPictureEvent extends UpcomingEvent {
    ...
    public WikipediaTodaysFeaturedPictureEvent(EventDate date, String description, String imageURL, EventSources externalSources) {
        super(date, null, description, imageURL, null, null, null);
