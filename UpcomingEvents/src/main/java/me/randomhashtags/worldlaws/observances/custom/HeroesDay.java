...
public enum HeroesDay implements CustomHoliday {
    INSTANCE;
    ...
    public EventDate getDate(WLCountry country, int year) {
        switch (country) {
            ...
            case BERMUDA: return EventDate.getThird(DayOfWeek.MONDAY, Month.JUNE, year);
            ...
            case JAMAICA: return EventDate.getThird(DayOfWeek.MONDAY, Month.OCTOBER, year);
            ...
            case PHILIPPINES: return EventDate.getLast(DayOfWeek.MONDAY, Month.AUGUST, year);
            ...
            case ZIMBABWE: return EventDate.getSecond(DayOfWeek.MONDAY, Month.AUGUST, year);
            default: return null;
        }
    }
}
