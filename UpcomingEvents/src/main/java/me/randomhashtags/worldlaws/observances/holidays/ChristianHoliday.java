        ...
        switch (this) {
            case ALL_SAINTS_DAY:
                if(isWestern) {
                    ...
                    return pentecost != null ? getFirst(DayOfWeek.SUNDAY, year, pentecost.getMonth(), pentecost.getDay()) : null;
                }
            case ALL_SOULS_DAY:
            ...
            case ASH_WEDNESDAY:
                if(isWestern) {
                    ...
                    return sevenWeeksBefore != null ? getFirst(DayOfWeek.WEDNESDAY, year, sevenWeeksBefore.getMonth(), sevenWeeksBefore.getDay()) : null;
                }
                return null;
