...
public interface IHoliday extends Jsoupable {
    ...
    default String getName() {
        ...
        return wikipediaName != null ? wikipediaName : LocalServer.toCorrectCapitalization(getEnum().name(), false, "of", "and", "de", "the");
    }
    ...
    default String getWikipediaURL() {
        final String wikipediaName = getWikipediaName(), name = wikipediaName == null ? getName() : wikipediaName;
    ...
    default EventDate getFirst(DayOfWeek dayOfWeek, int year, Month month, int day) {
