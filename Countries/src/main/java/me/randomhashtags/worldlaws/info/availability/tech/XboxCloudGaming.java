...
public enum XboxCloudGaming implements CountryService {
    INSTANCE;
    ...
    private void refresh(CompletionHandler handler) {
        ...
        availabilities.put("northkorea", value);
        availabilities.put("southkorea", value);
        ...
        WLLogger.log(Level.INFO, "XboxCloudGaming - refreshed (took " + (System.currentTimeMillis()-started) + "ms)");
        handler.handle(null);
    }
}
