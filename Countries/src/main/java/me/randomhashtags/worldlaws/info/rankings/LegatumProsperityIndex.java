...
public enum LegatumProsperityIndex implements CountryRankingService {
    ...
    private String getValue(String countryBackendID) {
        ...
        if(value.equals("null")) {
            WLLogger.log(Level.WARNING,"LegatumProsperityIndex - missing value for country \"" + countryBackendID + "\"!");
        }
        return value;
    }
    ...
    private void refresh(CompletionHandler handler) {
        ...
        if(doc != null) {
            ...
            WLLogger.log(Level.INFO, "LegatumProsperityIndex - refreshed " + countries.size() + " countries (took " + (System.currentTimeMillis()-started) + "ms)");
            handler.handle(null);
        }
    }
}
