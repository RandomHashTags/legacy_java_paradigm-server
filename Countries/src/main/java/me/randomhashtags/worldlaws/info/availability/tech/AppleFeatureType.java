...
public enum AppleFeatureType {
    ...
    private static HashMap<String, Element> getSections(String type) {
        ...
        final Elements sections = Jsoupable.getStaticDocumentElements(FileType.COUNTRIES_AVAILABILITIES, "https://www.apple.com/" + type + "/feature-availability", true, "body.page-overview main.main section.section");
