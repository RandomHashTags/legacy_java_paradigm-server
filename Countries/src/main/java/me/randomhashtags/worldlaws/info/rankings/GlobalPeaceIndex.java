...
public enum GlobalPeaceIndex implements CountryRankingService {
    ...
    private String getValue(String countryBackendID) {
        ...
        if(value.equals("null")) {
            WLLogger.log(Level.WARNING,"GlobalPeaceIndex - missing value for country \"" + countryBackendID + "\"!");
        }
        return value;
    }
    ...
    private void refresh(CompletionHandler handler) {
        ...
        if(doc != null) {
            ...
            WLLogger.log(Level.INFO, "GlobalPeaceIndex - refreshed " + countries.size() + " countries (took " + (System.currentTimeMillis()-started) + "ms)");
            handler.handle(null);
        }
    }
}
