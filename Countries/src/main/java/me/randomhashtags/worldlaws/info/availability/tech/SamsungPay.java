...
public enum SamsungPay implements CountryService {
    INSTANCE;
    ...
    private void refresh(CompletionHandler handler) {
        ...
        if(doc != null) {
            ...
            trs.remove(0);
            final EventSources sources = new EventSources(new EventSource("Wikipedia: Samsung Pay", url));
            ...
            WLLogger.log(Level.INFO, "SamsungPay - refreshed (took " + (System.currentTimeMillis()-started) + "ms)");
            handler.handle(null);
        }
    }
}
