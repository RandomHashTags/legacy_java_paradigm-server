...
public enum Hulu implements CountryService {
    INSTANCE;
    ...
    private void refresh(CompletionHandler handler) {
        ...
        availabilities.put("unitedstates", new CountryAvailability(title, true, CountryAvailabilityCategory.ENTERTAINMENT_STREAMING).toString()); // https://en.wikipedia.org/wiki/Hulu#International_availability
        WLLogger.log(Level.INFO, "Hulu - refreshed (took " + (System.currentTimeMillis()-started) + "ms)");
        handler.handle(null);
    }
}
