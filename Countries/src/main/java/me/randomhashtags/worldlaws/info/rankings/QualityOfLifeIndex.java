...
public enum QualityOfLifeIndex implements CountryRankingService {
    ...
    private String getValue(String countryBackendID) {
        ...
        if(value.equals("null")) {
            WLLogger.log(Level.WARNING,"QualityOfLifeIndex - missing value for country \"" + countryBackendID + "\"!");
        }
        return value;
    }
    ...
    private void refresh(CompletionHandler handler) {
        ...
        if(doc != null) {
            ...
            WLLogger.log(Level.INFO, "QualityOfLifeIndex - refreshed (took " + (System.currentTimeMillis()-started) + "ms)");
            handler.handle(null);
        }
    }
}
