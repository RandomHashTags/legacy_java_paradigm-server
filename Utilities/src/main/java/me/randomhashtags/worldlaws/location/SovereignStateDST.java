...
public final class SovereignStateDST {
    private final int startMonth, startDay, endMonth, endDay;

    public SovereignStateDST(LocalDateTime startDate, LocalDateTime endDate) {
    ...
    public SovereignStateDST(int startMonth, int startDay, int endMonth, int endDay) {
