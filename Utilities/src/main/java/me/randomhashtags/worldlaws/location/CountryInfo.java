...
public enum CountryInfo {
    ...
    RANKING_CLIMATE_CHANGE_PERFORMANCE_INDEX("Climate Change Performance Index"),
    RANKING_CO2_EMISSIONS("CO2 Emissions"),
    RANKING_CORRUPTION_PERCEPTION_INDEX("Corruption Perception Index"),
    RANKING_DEBT_CURRENT("Debt Current"),
    RANKING_DEMOCRACY_INDEX("Democracy Index"),
    RANKING_ECONOMIC_FREEDOM_INDEX("Economic Freedom Index"),
    RANKING_EDUCATION_INDEX("Education Index"),
    RANKING_ELECTRICITY_CONSUMPTION("Electricity Consumption"),
    RANKING_FRAGILE_STATE_INDEX("Fragile State Index"),
    RANKING_FREEDOM_RANKINGS("Freedom Rankings"),
    RANKING_GLOBAL_PEACE_INDEX("Global Peace Index"),
    RANKING_GLOBAL_TERRORISM_INDEX("Global Terrorism Index"),
    RANKING_HOMICIDE_RATE("Homicide Rate"),
    RANKING_HUMAN_DEVELOPMENT_INDEX("Human Development Index"),
    ...
    RANKING_PRESS_FREEDOM_INDEX("Press Freedom Index"),
    RANKING_QUALITY_OF_LIFE_INDEX("Quality of Life Index"),
    RANKING_QUALITY_OF_NATIONALITY_INDEX("Quality of Nationality Index"),
    RANKING_SOCIAL_PROGRESS_INDEX("Social Progress Index"),
    RANKING_SUICIDE_RATE("Suicide Rate"),
    RANKING_UNEMPLOYMENT_RATE("Unemployment Rate"),
    RANKING_WORLD_GIVING_INDEX("World Giving Index"),
    RANKING_WORLD_HAPPINESS_REPORT("World Happiness Report"),
