...
public final class StateStatute {
    private final StateReference reference;
    private String topic, description, json;

    private List<Subdivision> subdivisions;

    public StateStatute(StateReference reference, String topic, String description) {
        this(reference, topic, description, new ArrayList<>());
    }
    public StateStatute(StateReference reference, String topic, String description, List<Subdivision> subdivisions) {
