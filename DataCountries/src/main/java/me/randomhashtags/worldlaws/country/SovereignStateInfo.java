...
public enum SovereignStateInfo {
    ...
    AVAILABILITY_APPLE_ICLOUD_PLUS("Apple: iCloud+"),
    ...
    AVAILABILITY_APPLE_IOS_HEALTH_BLOOD_GLUCOSE_HIGHLIGHTS("Apple: Health: Blood Glucose Highlights"),
    AVAILABILITY_APPLE_IOS_HEALTH_DOWNLOAD_HEALTH_RECORDS_TO_IPHONE("Apple: Health: Download Health Records to iPhone"),
    AVAILABILITY_APPLE_IOS_HEALTH_SHARE_HEALTH_APP_DATA_WITH_HEALTHCARE_PROVIDERS("Apple: Health: Share Health App Data with Healthcare Providers"),
    AVAILABILITY_APPLE_IOS_ITUNES_STORE_MOVIES("Apple: iTunes Store: Movies"),
    AVAILABILITY_APPLE_IOS_ITUNES_STORE_MUSIC("Apple: iTunes Store: Music"),
    //AVAILABILITY_APPLE_IOS_ITUNES_STORE_RINGTONES_AND_TONES("iTunes Store: Ringtones & Tones"),
    AVAILABILITY_APPLE_IOS_ITUNES_STORE_TV_SHOWS("Apple: iTunes Store: TV Shows"),
